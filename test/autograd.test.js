...
describe('test of eval and diff calculation', () => {
  ...
  it('case 18', () => {
    ...
    r.forward()
    r.backward()
    //assert.equal(Math.abs(r.value - (-55 / 672)) < epsilon, true)
    //assert.equal(Math.abs(x.derivative - (551 / 12544)) < epsilon, true)
    //assert.equal(Math.abs(y.derivative - (-4213 / 16128)) < epsilon, true)
